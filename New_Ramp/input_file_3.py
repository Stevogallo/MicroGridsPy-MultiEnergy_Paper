...
LI_outdoor_bulb = LI.Appliance(LI,1,150,2,60,0.2,30)
LI_outdoor_bulb.windows([0,420],[1200,1440],0.35)

LI_TV = LI.Appliance(LI,2,60,2,240,0.1,30)
...
School_indoor_bulb = School.Appliance(School,60,60,1,480,0.1,30, wd_we_type = 0)
School_indoor_bulb.windows([480,1080],[0,0])

School_outdoor_bulb = School.Appliance(School,10,60,1,360,0.1,30, wd_we_type = 0)
School_outdoor_bulb.windows([480,1080],[0,0])

School_phone_charger = School.Appliance(School,40,5,1,240,0.1,30, wd_we_type = 0)
School_phone_charger.windows([480,1080],[0,0])

School_PC = School.Appliance(School,25,70,1,480,0.1,60, wd_we_type = 0)
School_PC.windows([480,1080],[0,0])

School_TV = School.Appliance(School,10,150,1,120,0.1,30, wd_we_type = 0)
School_TV.windows([480,1080],[0,0]), 

School_radio = School.Appliance(School,25,7,1,360,0.1,30, wd_we_type = 0)
