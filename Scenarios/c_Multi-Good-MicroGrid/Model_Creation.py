...
from Initialize import Initialize_years, Initialize_Electric_Energy_Demand, Initialize_RES_Energy, Initialize_Thermal_Energy_Demand # Import library with initialitation funtions for the parameters
...
def Model_Creation(model):
    ...
    model.RES_Investment_Cost = Param(within=NonNegativeReals)       # Investment cost of RES unit in USD/W
